...
/*
 function removeDuplicates(numsArr) {
   let set = new Set(numsArr);
   console.log(set);
   return Array.from(set);
 }
 
 let input1 = [0, 0, 1, 1, 1, 2, 2, 3, 3, 4];
 let result1 = removeDuplicates(input1);
...
function removeDuplicates(numsArr) {
  let i = 0;
  for (let j = 1; j < numsArr.length; j++) {
...
let result2 = removeDuplicates(input2);
